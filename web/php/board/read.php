<?php
	include $_SERVER['DOCUMENT_ROOT']."/a/db.php"; /* db load */
?>
<!doctype html>
<head>
<meta charset="UTF-8">
...
<div id="board_read">
	<h2><?php echo $board['title']; ?></h2>
		<div id="user_info">
			...
			<div>
				파일 : <a href="D:\Software_Tool\php-xampp\htdocs\a\upload<?php echo $board['file'];?>" download><?php echo $board['file']; ?></a>
			</div>
			<div id="bo_content">
	...
	<div id="bo_ser">
		<ul>
			<li><a href="/a/board.php">[목록으로]</a></li>
			<li><a href="/a/modify.php?idx=<?php echo $board['idx']; ?>">[수정]</a></li>
			<li><a href="/a/delete.php?idx=<?php echo $board['idx']; ?>">[삭제]</a></li>
		</ul>
	</div>
</div>
<!--- 댓글 불러오기 -->
